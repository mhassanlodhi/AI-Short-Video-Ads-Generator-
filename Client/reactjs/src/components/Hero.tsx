                        ...
                        <div className="text-left">
                            ...
                            >
                                ...
                                <span className="text-xs text-gray-200/90">
                                    Trusted by 10,000+ founders, startups & global teams
                                </span>
                            </motion.a>
                            ...
                            >
                                Upload your product images and a model photo - our AI 
                                instantly produces professional lifestyle imagery and 
                                short-form videos optimized for social media, commercials & Reels
                            </motion.p>
                            ...
                            >
                                ...
                                <div className="flex items-center gap-2 p-2 px-3 sm:px-6.5 hover:bg-white/3 transition-colors">
                                    ...
                                    <div>
                                        <div>Commerical rights</div>
                                        <div className="text-xs text-gray-400">
                                            Use anywhere, no attribution
                                        </div>
                                    </div>
                                </div>
                            </motion.div>
