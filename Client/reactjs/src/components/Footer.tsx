            ...
            <div className="max-w-6xl mx-auto px-6">
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-white/10">
                    <div>
                        ...
                        <p className="max-w-[410px] mt-6 text-sm leading-relaxed">
                            Create viral UGC in seconds. Upload product images and a model photo - our AI generates high-quality, social-ready videos and images that drive real results. Perfect for e-commerce, social media and beyond.
                        </p>
                    </div>
                ...
                <p className="py-4 text-center text-sm text-gray-400">
                    © {new Date().getFullYear()} {' '}
                        ...
                        Pixel Forge . All rights reserved.
                </p>
            </div>
        </motion.footer>
    );
