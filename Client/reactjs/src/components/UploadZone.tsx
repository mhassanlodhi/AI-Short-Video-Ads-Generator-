  ...
  return (
    <div className="relative group">
        <div className={`relative h-64 rounded-2x1 border-2
            border-solid transitioned-all duration-300 flex flex-col
            items-center justify-center bg-white/2 p-6 ${file ? 'border-violet-600/500 bg-violet-500/5' :
            'border-white/100 hover:border-violet-500/30 hover:bg-vwhite/5'}`}>
                ...
                {file ? (
                    ...
                    rounded-x1 backdrop-blur-sm" >
                        <button type="button" onClick={onClear} className="p-2 rounded-full bg-white/10 
                    ...
                    <p className="text-sm text-graay-400 text-center max-w[200px]">
